  ...
  return (
    <div className="relative p-6 bg-white z-1 dark:bg-black sm:p-0">
      <div className="relative flex flex-col justify-center w-full h-screen lg:flex-row dark:bg-black sm:p-0">
        {children}
        <div className="items-center hidden w-full h-full lg:w-1/2 bg-orange-900 dark:bg-white/5 lg:grid">
          <div className="relative flex items-center justify-center z-1">
            ...
            <div className="flex flex-col items-center max-w-xs">
              ...
              <p className="text-center text-gray-400 dark:text-white/60">
                Bienvenido al sistema de gestión interna del Hotel Plaza Trujillo.
              </p>
            </div>
          </div>
        </div>
